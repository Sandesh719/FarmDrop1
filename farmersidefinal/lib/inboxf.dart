...
class MessageListPage extends StatelessWidget {
  final List<Message> messages = [
    Message(sender: 'Customer A', location: 'Pune', content: 'Offer recieved'),
    Message(sender: 'Customer B', location: 'Nagpur', content: 'Confirm the date and time pls'),
    Message(sender: 'Customer C', location: 'Mumbai', content: 'ठीक आहे. नंतर सांगतो.'),
    Message(sender: 'Customer D', location: 'Aurangabad', content: 'Sent money. Please check. Thanks'),
    Message(sender: 'Customer E', location: 'Nashik', content: 'Okay.'),
  ];
